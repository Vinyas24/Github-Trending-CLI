...
public class CliArgumentsTest {
        ...
        void parseAllOptionalValues() {
                String[] args = { "java", "10", "--sort", "forks", "--order", "asc", "--page", "2", "--min-stars",
                                "1000" };
                CliArguments cliArguments = CliArguments.parse(args);
                assertEquals("java", cliArguments.getLanguage());
                assertEquals(10, cliArguments.getCount());
        ...
        void throwExceptionWhenCountGreaterThan100() {
                ...
                InvalidCliArgumentException e = assertThrows(InvalidCliArgumentException.class,
        ...
        @Test
        void parseDurationMonth() {
                String[] args = { "java", "10", "--duration", "month" };
                CliArguments cliArguments = CliArguments.parse(args);
                assertEquals(DurationType.MONTH, cliArguments.getDuration());
        }

        @Test
        void throwExceptionWhenDurationIsInvalid() {
                String[] args = { "java", "10", "--duration", "abc" };
                InvalidCliArgumentException e = assertThrows(
                                InvalidCliArgumentException.class,
                                () -> CliArguments.parse(args));
                assertEquals(
